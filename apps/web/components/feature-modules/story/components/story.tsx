...
export const Story = () => {
  return (
    <Section id="story" size={24} className="mt-20">
      <article className="clamp relative z-10 mx-auto flex max-w-4xl flex-col">
        <h1 className="text-center font-sans text-[clamp(1.75rem,8vw,2.75rem)] leading-none tracking-tighter text-heading sm:text-5xl md:text-[4rem]">
          Why I am building <span className="font-serif font-normal italic">Riven</span>
        </h1>

        <div className="mt-10 px-4 sm:px-8 lg:px-12">
          <h3 className="font-sans text-3xl leading-none tracking-tighter text-primary md:text-4xl lg:text-5xl">
            One man. One Dream.{' '}
            <span className="font-serif font-normal italic">Too many tabs.</span>
          </h3>
          <p className="mt-2 text-sm leading-relaxed text-content/70 md:text-base">
            No I dont want to open another tab leave me alone
          </p>
        </div>

        <section className="mt-16 space-y-6 px-4 text-base leading-relaxed tracking-tight text-content/80 sm:px-8 md:text-lg md:leading-relaxed lg:px-12">
          <SectionDivider>The Problem</SectionDivider>
          ...
          <p>
            There is no doubt in my mind that the rise of SaaS gave businesses access to
            expert-level functionality overnight and the innate ability to grow beyond their wildest
            dreams. AI and automation made it possible for a single person to run what used to take
            an entire team. But all of it assumes you have the time, or the systems, to pull it all
            together. And most of us don&apos;t. We just become the glue. Opening tab after tab,
            cross-referencing dashboards, copying numbers into spreadsheets, trying to assemble some
            version of the truth.
          </p>

          <p>
            For teams, who have better things to do, marketing campaigns to run, customers to talk
            to, or for someone trying to run a company alone. This overhead adds up quickly. You are
            not lacking information. You are lacking a system that keeps everything connected.
          </p>
        ...
        <section className="mt-16 space-y-6 px-4 text-base leading-relaxed tracking-tight text-content/80 sm:px-8 md:text-lg md:leading-relaxed lg:px-12">
          <SectionDivider>The Idea</SectionDivider>
        ...
        <section className="mt-16 space-y-6 px-4 text-base leading-relaxed tracking-tight text-content/80 sm:px-8 md:text-lg md:leading-relaxed lg:px-12">
          <SectionDivider>The Focus</SectionDivider>
          ...
          <p>
            ...
            &ldquo;be data-driven&rdquo; without a single analyst on payroll, for the one employee
            who is just supposed to &ldquo;know&rdquo; how the business is working.
          </p>
          ...
          <p>
            ...
            work, who need lifecycle visibility without the overhead to expand, the resources to
            scope in on the acquisition channels that are actually working, and to keep the
            customers lining their pockets.
          </p>
          ...
          <p>
            I don&apos;t care about being professional. I care about whether you can understand
            what&apos;s happening in your business without it becoming your entire day, I care about
            revealing the patterns that were hiding, showcasing the timely actions that are crucial
            to keeping a customer, the channels that you need to be doubling down in.
          </p>

          <p className="text-content">
            Your tools already have the answers. They know the next steps for your business. They
