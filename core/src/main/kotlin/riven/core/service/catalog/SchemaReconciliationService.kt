...
import cranium.core.models.catalog.EntityTypeHealthStatus
import cranium.core.models.catalog.EntityTypeImpact
import cranium.core.models.catalog.PendingSchemaChange
import cranium.core.models.catalog.ReconciliationImpact
import cranium.core.models.catalog.ReconciliationResult
import cranium.core.models.catalog.ReconciledEntityType
import cranium.core.models.catalog.SchemaChange
import cranium.core.models.catalog.SchemaHealthResponse
import cranium.core.models.catalog.SchemaHealthStatusType
import cranium.core.models.catalog.SchemaHealthSummary
...
class SchemaReconciliationService(
     ...
     *
     * Integration-sourced rows are intentionally excluded by the underlying enqueue path: per the
     * Entity Reconsumption architecture, historical/integration entities are tier 1 ("DO NOT"
     * reconsume) — they are source-of-truth records, never enriched directly, and therefore have
     * no `entity_connotation` snapshot for a manifest change to invalidate.
     *
