  ...
  return (
    <footer className="z-[0] border-t border-t-content/35 bg-background">
      <div className="mx-auto flex max-w-[min(90vw,var(--breakpoint-3xl))] flex-col justify-between space-y-4 px-6 py-8 text-xs sm:px-20 sm:text-sm xl:flex-row">
        ...
        <div className="w-full grow text-start font-display text-content xl:text-end">
          Think Fast. Act Fast. Grow Fast
        </div>
      </div>
      <div className="mx-auto flex max-w-[min(90vw,var(--breakpoint-3xl))] flex-wrap items-start gap-y-8 px-6 py-8 sm:flex-nowrap sm:px-20">
        ...
        <div className="flex w-full justify-start font-display text-content sm:w-auto sm:grow sm:justify-end">
          <div className="font-display text-content">
            <h3 className="font-display text-xs font-bold tracking-[0.05em] text-foreground uppercase">
              Privacy & Terms
            </h3>
            <ul className="flex flex-col">
