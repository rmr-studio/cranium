package cranium.core.enums.enrichment
 ...
 *
 * Bound from `cranium.enrichment.provider` in application.yml. Spring's relaxed
 ...
 * [cranium.core.service.enrichment.provider.OpenAiEmbeddingProvider] and
 * [cranium.core.service.enrichment.provider.OllamaEmbeddingProvider] continue to
